        ...
        <div className=" w-screen flex items-center justify-center bg-gray-900 text-white">
          <div className="max-w-6xl text-center animate-float bg-gray-700 p-8 rounded-lg shadow-lg">
            ...
            <p className="text-gray-300 md:text-4xl text-base leading-relaxed">
              I'm Mohamed Hassan, a full-stack web developer with a strong focus
              on frontend technologies. I specialize in building intuitive,
              responsive, and high-performance interfaces using React, Next.js,
              and Tailwind CSS. I’m also familiar with backend development using
              Node.js, Express, and MongoDB, allowing me to build and integrate
              full web solutions from frontend to database.
            </p>
          </div>
        </div>
      </div>
