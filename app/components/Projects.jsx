...
export const projects = [
  ...
  { url: "https://2mohamedhssan.github.io/Memory-Game/", tools: ["HTML5", "CSS3", "JavaScript"], imgsrc: "/Memory.png", pname: "Memory-Game", category: "Games" },
  { url: "https://2mohamedhssan.github.io/Hangman-Game/", tools: ["HTML5", "CSS3", "JavaScript"], imgsrc: "/Hangman.png", pname: "Hangman-Game", category: "Games" },
  { url: "https://2mohamedhssan.github.io/TypingRace-Game/", tools: ["HTML5", "CSS3", "JavaScript"], imgsrc: "/typing.png", pname: "TypingRace-Game", category: "Games" },
  { url: "https://2mohamedhssan.github.io/Question-Game/", tools: ["HTML5", "CSS3", "JavaScript"], imgsrc: "/Qustion.png", pname: "Qustion-Game", category: "Games" },
];

function Projects() {
  const [activeCategory, setActiveCategory] = useState("All");
  const categories = ["All", "HTML&CSS", "JavaScript", "Reactjs", "Nextjs", "Games"];
