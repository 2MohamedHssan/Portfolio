  ...
  return (
    <div>
      <div
        ...
        className="font-sans hidden lg:block font-light m-0 p-0 w-auto h-screen overflow-auto"
      >
          ...
          <div className="pin-wrap flex relative z-10">
            <div className="animation-wrap to-right flex relative z-10">
              <div className="item px-[80px] py-[150px] overflow-hidden flex-none w-screen h-[calc(100vh-300px)] flex flex-col items-center bg-gray-900">
                ...
                <h1
                  data-aos="zoom-in"
                  className="text-3xl font-bold py-2 text-flicker-in-glow md:text-5xl lg:text-7xl"
                >
                  MOHAMED HASSAN
                </h1>
              </div>
              <div className="item px-[80px] flex-none w-screen h-[calc(100vh-300px)] flex items-center justify-center bg-gray-900 text-white">
                <div className="max-w-6xl text-center animate-float bg-gray-700 p-8 rounded-lg shadow-lg">
                  <h2 className="text-4xl md:text-7xl font-bold text-teal-400 mb-6">
                    Who I Am
                  </h2>
                  <p className="text-gray-300 md:text-4xl text-base leading-relaxed">
                    I'm Mohamed Hassan, a full-stack web developer with a strong
                    focus on frontend technologies. I specialize in building
                    intuitive, responsive, and high-performance interfaces using
                    React, Next.js, and Tailwind CSS. I’m also familiar with
                    backend development using Node.js, Express, and MongoDB,
                    allowing me to build and integrate full web solutions from
