...
export const experiences = [
  ...
  },
  {
    ...
    description:
      "Developing and optimizing user interfaces using React and Tailwind CSS. Working on a large dashboard with nested and dynamic routes.",
  },
  {
    ...
    description:
      "Gaining hands-on experience in full-stack development using Node.js and React. Working on backend APIs and front-end interfaces.",
  },
  {
    company: "NCPC",
    role: "IT Support",
    ...
    <div className="text-white">
      <AnimatedHeader
        ...
        Children={
          <section
            id="experience"
            className="py-10 px-6 bg-gray-900 text-white"
          >
            <div className=" container max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold border-b-2 border-teal-400 pb-2 mb-6">
                Work Experience
              </h2>
