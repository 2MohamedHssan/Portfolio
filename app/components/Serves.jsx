...
export default function Serves() {
  return (
    <div id='servecis' className='bg-[#20242d] text-white/80 py-16'>
      ...
      <div className='grid grid-cols-1 container mx-auto p-3 sm:grid-cols-2 md:grid-cols-3 gap-5'>
        ...
        <div data-aos="fade-up" duration='1500' className='flex justify-center my-4 text-[#01f3f4]'><FaCode size={50} /></div>
          ...
          <button className="bg-[#01f3f4] hover:bg-[#01f4f4ab] rounded-md mt-4 px-4 py-2">Read More</button>
        </div>
        <div data-aos="fade-up" className='bg-[#323846] rounded-md p-4 text-center'>
          <div duration='1500' data-aos="fade-up" className='flex justify-center my-4 text-[#01f3f4]'><BsPalette size={50} /></div>
        ...
        <div data-aos="fade-up" className='bg-[#323846] rounded-md p-4 text-center'>
          <div data-aos="fade-up" duration='1500' className='flex justify-center my-4 text-[#01f3f4]'><FiTrendingUp size={50} /></div>
